...
describe("Reducer of ReduxToolkit", () => {
    ...
    describe("incrementByAmount action", () => {
        ...
        it("should increment by payload value woth mode 0", () => {
            const action = { type: incrementByAmount.type, payload: 3 };
            const state = reducer(initialState, action);
            expect(state.value).toEqual(4);
        });
        it("should increment by 100 * payload value woth mode 1", () => {
            initialState = {
                mode: 1,
                value: 1,
            };
        ...
        it("should increment by 10000 * payload value woth mode 2", () => {
            initialState = {
                mode: 2,
                value: 1,
            };
